...
| `POST /api/pane/capture` | `{pane: "%N", lines?: N}` — pane contents with color/attribute escapes preserved; `lines` adds N lines of scrollback (`capture-pane -p -e -S -N`, capped) |
